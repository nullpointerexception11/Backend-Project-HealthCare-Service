...
import com.springproject.backendprojecthealthcareservice.service.PatientService;
...
public class PatientController {
    ...
    @GetMapping("")
    @PreAuthorize("hasRole('PATIENT')")
    public ResponseEntity<List<PatientDTO>> getPatientsUserById(HttpServletRequest request) {
    ...
    @PreAuthorize("hasRole('ADMIN') or hasRole('DOCTOR') or hasRole('NURSE') or hasRole('SECRETARY')")
    public ResponseEntity<List<PatientDTO>> getPatientGetUserIdAuth(@PathVariable Long userId) {
